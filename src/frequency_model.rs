...
const RU_COMMON: &str = concat!(
    "автомат блоки ведут вещающих внутрь встреча выделен выучку герц герцшпрунга говорит голов гонтарук длин доступны европа здоров инструкцию интерференции кома крузенштерна куйбышеве культуру курляндскую кючук математика образ образов пешей почт продолжит прото реально росс русскую свободны семь скупку солнечная союз структурную тепе трук увеличив устройств уходит учеб физика чешку якуты привет система сервер пользователь безопасность окно данные код проверка объект сеть служба файл приложение процесс ввод клавиатура раскладка настройки ручной автоматический текущий предыдущий выделенный текст слово тест релиз сборка обновление локальный приватность пароль защита коробка коробочка свобода свободу свободный хорошо работает работаю ",
