...
fn with_focused_element<T>(
    ...
    AUTOMATION.with(|slot| {
        ...
        // Some UIA providers expose NativeWindowHandle=0 or a descendant HWND
        // rather than the GUITHREADINFO focus HWND. Bind by process; if a native
        // HWND is supplied, verify that it belongs to the same process.
