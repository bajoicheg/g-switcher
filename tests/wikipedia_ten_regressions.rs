...
const SAFE_CORRECTIONS: &[&str] = &[
    "автомат", "блоки", "ведут", "вещающих", "внутрь", "встреча", "выделен",
    "выучку", "герц", "герцшпрунга", "говорит", "голов", "гонтарук", "длин",
    "доступны", "европа", "здоров", "инструкцию", "интерференции", "кома",
    "крузенштерна", "куйбышеве", "культуру", "курляндскую", "кючук", "математика",
    "образ", "образов", "пешей", "почт", "продолжит", "прото", "реально", "росс",
    "русскую", "свободны", "семь", "скупку", "солнечная", "союз", "структурную",
    "тепе", "трук", "увеличив", "устройств", "уходит", "учеб", "физика", "чешку",
    "якуты",
];

const INTENTIONAL_KEEP: &[&str] = &[
    "внук", "гор", "дан", "дум", "зап", "кут", "луны", "мвт", "мкм", "мкс", "нев",
    "ран", "рын", "сем", "сер", "ста", "ток", "тян", "эне",
];
